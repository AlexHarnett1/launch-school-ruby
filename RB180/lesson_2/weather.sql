...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: alexharnett
--
...
ALTER TABLE public.weather OWNER TO alexharnett;

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: alexharnett
--
